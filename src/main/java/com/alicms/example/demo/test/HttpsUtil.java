...
public class HttpsUtil {
    //CA根证书文件路径
    private String caPath="D:\\workspace\\IdeaProjects\\demo0819\\springboot-demo1\\src\\main\\java\\cert\\private_full_node.jks";
    //CA根证书生成密码
    private String caPassword="123456";
    //客户端证书文件名
    private String clientCertPath="D:\\workspace\\IdeaProjects\\demo0819\\springboot-demo1\\src\\main\\java\\cert\\private_full_node.jks";
    //客户端证书生成密码
    ...
    public static void main(String[] args) throws Exception {
        Map<String, Object> stringObjectMap = new HttpsUtil().httpsPost("https://192.168.10.236:8555/get_blockchain_state", "");
    ...
    public Map<String,Object> httpsPost(String requestUrl, String xml) throws Exception {
        ...
        try {
            ...
            System.out.println("HTTPS请求出现异常，请求参数为："+xml);
            e.printStackTrace();
            throw e;
        }finally {
            try{
