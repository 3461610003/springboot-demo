...
public class NameGenerate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(randomName(false, 4));//三位数
...
//        }
    ...
    private static final String[] SUR_NAME = {
            ...
            "谯", "笪", "年", "爱", "阳", "佟"};
    private static final String[] DOUBLE_SUR_NAME = {
    ...
    public static String getIdNo(Date birthday, Boolean male) {
        if (birthday == null && male == null) return getIdNo();
        if (birthday == null) return getIdNo(male);
    ...
    public static String getIdNo() {
        ...
        return getIdNo(birth, new Random().nextInt(2) == 0);
    }
    ...
    public static String get5Random() {
        return UUID.randomUUID().toString().replaceAll("-", "").toLowerCase().substring(0, 5);
    }
