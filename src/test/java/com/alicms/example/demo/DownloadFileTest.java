...
//        paramMap.put("40", Arrays.asList("https://res001.geekbang.org/media/audio/47/92/47d7c5a60208e19a8d718e56c11d7292/ld/ld-", "答疑篇3：代码篇思考题集锦（三）"));
        ...
        for (String key : paramMap.keySet()) {
            ...
            downFile(url,srcPath + path, desPath);  // 下载文件
            mergeFile(srcPath + path, desPath, paramMap.get(key).get(1));  // 合并文件
        }
    }

    public static void downFile(String url, String srcPath, String descPath) throws InterruptedException {
...
//        header.put(":scheme", "https");
        ...
        header.put("cookie", "_ga=GA1.2.1525517221.1594892881; _gid=GA1.2.430506280.1594892881; LF_ID=1594892881994-2024361-5774181; GCID=da6442b-40322ba-910ef2c-253accb; GRID=da6442b-40322ba-910ef2c-253accb; GCESS=BQgBAwUEAAAAAAIEbiIQXwQEAC8NAAEI6GYeAAAAAAADBG4iEF8KBAAAAAALAgUABgQT52QkCQEBBwTcqt8UDAEB; acw_tc=7b39758315950552464903594e7f1241c17d55b5a061410236da545ca695f4; gksskpitn=6bcb5d19-bfb0-41d4-a2fa-a7032dd667c2; Hm_lvt_59c4ff31a9ee6263811b23eb921a5083=1594690932,1594892913,1594975510,1595055247; Hm_lvt_022f847c4e3acd44d4a2481d9187f1e6=1594690932,1594892913,1594975510,1595055247; Hm_lpvt_022f847c4e3acd44d4a2481d9187f1e6=1595055277; Hm_lpvt_59c4ff31a9ee6263811b23eb921a5083=1595055277; SERVERID=1fa1f330efedec1559b3abbcb6e30f50|1595055602|1595055246; _gat=1; gk_process_ev={%22count%22:10%2C%22target%22:%22%22}");
        ...
        while (result) {
            ...
            result = HttpClientUtils.doGetFile(url + str + ".ts", header, srcPath);
            Thread.sleep(80);
        }
    }
     ...
     * @param newFileName 合并文件名
     */
    public static void mergeFile(String srcPath, String desPath, String newFileName) {
        //		拆分
