...
public class CrawTextThread extends Thread {
    ...
    private static String PATH = "D:\\file\\jsoup\\";
    /**
     * 创建文件
     *
     * @param fileName
...
//        for (String url : UrlList) {
        String url = UrlList.get(0);
            try {
                ...
                title = document.select("#readArea > div.readAreaBox.content > h1").toString();
                content = document.select("#readArea > div.readAreaBox.content > div.p").html();
