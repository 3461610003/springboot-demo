...
//                "斗破苍穹.txt");
//        crawler.crawl();
        WebBookCrawler c2 = new WebBookCrawler("https://www.17k.com/chapter/924744/17207088.html",
                "#readArea > div.readAreaBox.content > h1",
                "#readArea > div.readAreaBox.content > div.p > p",
                "body > div.area > div.read > div.NextPrevBtn > ul > li.next > a",
                "洛洛历险记续集.txt");
        c2.crawl();
    }
}
